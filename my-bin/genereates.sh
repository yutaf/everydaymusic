...
rails g scaffold user email:string name:string first_name:string last_name:string gender:string locale:string timezone:integer fetch_cnt:integer delivery_time:time delivery_interval:time is_active:boolean
rails g model facebook user:references facebook_user_id:string
rails g model artist name:string
rails g model festival name:string
