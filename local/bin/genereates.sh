...
rails g model facebook user:references facebook_user_id:string accessToken:string salt:string
rails g scaffold user email:string name:string first_name:string last_name:string gender:string locale:string timezone:integer fetch_cnt:integer interval:integer time:time is_active:boolean
